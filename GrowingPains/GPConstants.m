...
NSString * const kGPUserDefaultsUserEmail         = @"kGPUserDefaultsUserEmail";
NSString * const kGPUserDefaultsUserName          = @"kGPUserDefaultsUserName";
...
NSString * const kSTKeychainServiceName           = @"kSTKeychainServiceName";